...
$.SOW.config["vendor:external_css"]["vendor"] = ["flickity","fancybox","cocoen","photoswipe","swiper","leaflet","fullcalendar","daterangepicker","colorpicker","flot","chartjs","mediumeditor","markdowneditor","summernoteeditor","quilleditor","datatables","prismjs"];$.SOW.config.autoinit['jarallax'] = ['$.SOW.vendor.jarallax.init','.jarallax', null,true];
...
$.SOW.config.autoinit['fullcalendar'] = ['$.SOW.vendor.fullcalendar.init','.fullcalendar', {plugins:["interaction","dayGrid","timeGrid","list","bootstrap","googleCalendar"],editable:true,eventLimit:true,locale:"en",themeSystem:"bootstrap",defaultView:"dayGridMonth",defaultDate:"2023-09-10T09:46:47.795Z",timeZone:"UTC",header:{left:"prev,next today, addEventButton",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay,listWeek"},buttonText:{today:"today",month:"month",week:"week",day:"day",list:"list"},eventTimeFormat:{hour:"numeric",minute:"2-digit",meridiem:"short"}},true];
...
$.SOW.config["vendor:external_js"]["vendor"] = ["flickity","fancybox","cocoen","photoswipe","swiper","leaflet","fullcalendar","daterangepicker","colorpicker","flot","easypie","chartjs","mediumeditor","markdowneditor","summernoteeditor","quilleditor","datatables","prismjs","pdfmake"];