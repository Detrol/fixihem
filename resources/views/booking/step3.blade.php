                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 mt-3 form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <div class="text-muted small">Du kommer få ett SMS med en länk som startar en Swish-betalning.</div>
                                    </div>
                                    <div class="form-check">
                                        ...
                                        <div class="text-muted small">Du får en faktura skickad till din mail i form av en fil.</div>
                                    </div>
                                </div>
                            </div>
...
föregående steg, eftersom vi räknar med tur/retur här, det gäller också priserna ovan."></i>
                        ...
                        <div class="alert alert-warning small p-3">
                            ...
                            <ul class="mt-2 mb-0 pl-1 text-dark">
                                ...
                                <li>Min taxa är 249 kr/timme (inklusive RUT), räknat från det att jag anländer till det att jag lämnar platsen.</li>
